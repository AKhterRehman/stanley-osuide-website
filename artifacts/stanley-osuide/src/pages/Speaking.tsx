  ...
  return (
    <div className="bg-background min-h-screen text-foreground">
      ...
      <section className="relative min-h-[58vh] sm:min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-20 md:pt-36 md:pb-24 bg-gradient-to-br from-white via-slate-50 to-blue-50/40">
        <div className="absolute inset-0 opacity-[0.28] pointer-events-none" style={{ backgroundImage: 'linear-gradient(120deg, rgba(255,255,255,0.94), rgba(248,250,252,0.88)), url("/images/client/stanley-client-14.jpeg")', backgroundSize: "cover", backgroundPosition: "center" }} />
        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          >
            {isPlayingReel ? (
              ...
              <>
                <img 
                  src="/images/client/stanley-client-14.jpeg" 
